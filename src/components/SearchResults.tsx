                        ...
                        >
                            <div className="block m-2 p-4 rounded-lg shadow-lg bg-gray-100 max-w-sm">
                                ...
                                <Link href={moreUrl}>
                                    <button
                                        type="button"
                                        className=" inline-block px-6 py-2.5 bg-yellow-300 hover:bg-yellow-200 text-black font-medium text-xs leading-tight uppercase rounded shadow-md hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:bg-yellow-400 active:shadow-lg transition duration-150 ease-in-out"
                                    >
                                        See more{' '}
